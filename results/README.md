...
built-in reference engine (21/21, score 1.0) — use it as the schema reference.
...
```jsonc
{
  ...
  "benchmark_version": "0.2.0",     // pins the case set the score is comparable within
  "engine": "reference",            // engine under test
  "engine_version": "0.2.0",         // your engine's version (--engine-version)
